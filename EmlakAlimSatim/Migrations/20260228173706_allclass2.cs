...
{
    /// <inheritdoc />
    public partial class allclass2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_kullanicilars_KullaniciId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "fa-home", true, "Konut" },
                    { 2, null, "fa-tree", true, "Arsa" },
                    { 3, null, "fa-building", true, "İşyeri" },
                    { 4, null, "fa-city", true, "Bina" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_KullaniciId",
                table: "Properties",
                column: "KullaniciId");
